...
/***/ function(module, exports, __webpack_require__) {
	...
	var FadeThroughComponent = __webpack_require__(154);
	...
	var FadeThroughContainer = module.exports = React.createClass({
	  ...
	  next: function next() {
	    return function () {
	      ...
	      if (this.state.activeIndex === this.props.children.length) this.setState({ activeIndex: 0 });
	    };
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var FadeThroughChild = __webpack_require__(155);
	      ...
	      this.props.children.map(function (child, index) {
	        return React.createElement(
	          FadeThroughChild,
	          {
	            ...
	            style: index === _this.props.activeIndex ? activeStyle : inactiveStyle
	          },
	          child
	        );
	      })
